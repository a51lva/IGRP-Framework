<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/objeto">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="objeto" item-type="text" required="required">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/objeto/value}" class="form-control " id="{rows/content/form_1/fields/objeto/@name}" name="{rows/content/form_1/fields/objeto/@name}" required="required" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/pagina">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="pagina" item-type="text" required="required">
                                                                        <label for="{rows/content/form_1/fields/pagina/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_1/fields/pagina/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/form_1/fields/pagina/value}" class="form-control " id="{rows/content/form_1/fields/pagina/@name}" name="{rows/content/form_1/fields/pagina/@name}" required="required" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_1/fields/formato_output">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="formato_output" item-type="text" required="required">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/formato_output/value}" class="form-control " id="{rows/content/form_1/fields/formato_output/@name}" name="{rows/content/form_1/fields/formato_output/@name}" required="required" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_1/fields/guardar_em">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="guardar_em" item-type="text" required="required">
                                                                        <label for="{rows/content/form_1/fields/guardar_em/@name}">
                                                                            <span>
                                                                                <xsl:value-of select="rows/content/form_1/fields/guardar_em/label"/>
                                                                            </span>
                                                                        </label>
                                                                        <input type="text" value="{rows/content/form_1/fields/guardar_em/value}" class="form-control " id="{rows/content/form_1/fields/guardar_em/@name}" name="{rows/content/form_1/fields/guardar_em/@name}" required="required" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="splist-form" role="form">
                                                                    ...
                                                                    <xsl:if test="rows/content/separatorlist_1/fields/campo">
                                                                        <div class="form-group col-sm-3   gen-fields-holder" item-name="campo" item-type="text">
                                                                            ...
                                                                            <input type="text" value="{rows/content/separatorlist_1/fields/campo/value}" class="form-control " id="{rows/content/separatorlist_1/fields/campo/@name}" name="{rows/content/separatorlist_1/fields/campo/@name}" maxlength="50" placeholder=""></input>
                                                                        </div>
                                                                    </xsl:if>
                                                                </div>
                                                            </div>
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1502712930927"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1502712930927"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1502712930927"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1502712930927"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1502712930927"/>
</xsl:stylesheet>
