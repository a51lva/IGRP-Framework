<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
                            ...
                            <div class="box-body">
                              <div role="form">
                                ...
                                <xsl:if test="rows/content/form_1/fields/imagem">
                                  <div class="form-group col-sm-6  gen-fields-holder" item-name="imagem" item-type="file" required="required">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-btn">
                                        <span class="btn btn-default file-btn-holder">
                                          ...
                                          <input id="{rows/content/form_1/fields/imagem/@name}" name="{rows/content/form_1/fields/imagem/@name}" required="required" value="{rows/content/form_1/fields/imagem/value}" target-rend="" class="transparent " type="file" accept=""/>
                                        </span>
                                      </span>
                                    </div>
                                  </div>
  ...
  <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1502796422059"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1502796422059"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1502796422059"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1502796422059"/>
  <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1502796422060"/>
</xsl:stylesheet>
