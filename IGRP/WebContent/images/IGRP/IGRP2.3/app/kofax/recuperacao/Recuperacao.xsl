<xsl:stylesheet
                                                            ...
                                                            <div role="form">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/tipo_objeto">
                                                                    <div class="col-sm-3 form-group  gen-fields-holder" item-name="tipo_objeto" item-type="select" required="required">
                                                                        ...
                                                                        <select class="form-control select2 " id="form_1_tipo_objeto" name="{rows/content/form_1/fields/tipo_objeto/@name}" required="required">
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/n_de_processo">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="n_de_processo" item-type="number" required="required">
                                                                        ...
                                                                        <input type="number" value="{rows/content/form_1/fields/n_de_processo/value}" class="form-control " id="{rows/content/form_1/fields/n_de_processo/@name}" name="{rows/content/form_1/fields/n_de_processo/@name}" required="required" min="" max="" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/n_de_documento">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="n_de_documento" item-type="number">
                                                                        ...
                                                                        <input type="number" value="{rows/content/form_1/fields/n_de_documento/value}" class="form-control " id="{rows/content/form_1/fields/n_de_documento/@name}" name="{rows/content/form_1/fields/n_de_documento/@name}" min="" max="" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/estante">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="estante" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/estante/value}" class="form-control " id="{rows/content/form_1/fields/estante/@name}" name="{rows/content/form_1/fields/estante/@name}" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_1/fields/pasta">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="pasta" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/pasta/value}" class="form-control " id="{rows/content/form_1/fields/pasta/@name}" name="{rows/content/form_1/fields/pasta/@name}" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_1/fields/livro">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="livro" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/livro/value}" class="form-control " id="{rows/content/form_1/fields/livro/@name}" name="{rows/content/form_1/fields/livro/@name}" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                <xsl:if test="rows/content/form_1/fields/folha">
                                                                    <div class="form-group col-sm-3   gen-fields-holder" item-name="folha" item-type="text">
                                                                        ...
                                                                        <input type="text" value="{rows/content/form_1/fields/folha/value}" class="form-control " id="{rows/content/form_1/fields/folha/@name}" name="{rows/content/form_1/fields/folha/@name}" maxlength="30" placeholder=""></input>
                                                                    </div>
                                                                </xsl:if>
                                                                ...
                                                                <xsl:if test="rows/content/form_1/fields/imagem">
                                                                    <div class="col-sm-12  holder-croppie gen-fields-holder" item-name="imagem">
                                                                        <div class="row">
                                                                            <img src="{rows/content/form_1/fields/imagem/value}" data-label="{rows/content/form_1/fields/imagem/label}" name="imagem" id="id-imagem" width="600" height="700" class=" croppie"/>
                                                                        </div>
                                                                    </div>
                                                                </xsl:if>
                                                            </div>
    ...
    <xsl:include href="../../../xsl/tmpl/IGRP-functions.tmpl.xsl?v=1503425610163"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-variables.tmpl.xsl?v=1503425610163"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-home-include.tmpl.xsl?v=1503425610163"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-utils.tmpl.xsl?v=1503425610164"/>
    <xsl:include href="../../../xsl/tmpl/IGRP-form-utils.tmpl.xsl?v=1503425610164"/>
</xsl:stylesheet>
