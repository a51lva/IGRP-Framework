...
public class PontoAtendimentoView extends View {
	...
	public PontoAtendimentoView(PontoAtendimento model){
		...
		inicio = new ListField(model,"inicio");
		inicio.setLabel("Inicio");
		inicio.propertie().add("name","p_inicio").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","true").add("change","false").add("disabled","false").add("right","false");
		fim = new ListField(model,"fim");
		fim.setLabel("Fim");
		fim.propertie().add("name","p_fim").add("type","select").add("multiple","false").add("domain","").add("maxlength","30").add("required","true").add("change","false").add("disabled","false").add("right","false");
